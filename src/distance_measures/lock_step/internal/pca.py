...
from distance_measures.lock_step.internal.pca_numba import pca_dist,pca_dist_mat,eros_dist_mat
...
def pca_all(X,Y, exvar=0.90):
    ...
    return pca_dist_mat(pcasX,pcasY,exvar)
...
def eros_all(X,Y):
    ...
    return eros_dist_mat(pcasX, pcasY, weights)
# Eros OK